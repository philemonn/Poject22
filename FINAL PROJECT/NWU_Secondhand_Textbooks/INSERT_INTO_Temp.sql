...
Values((Select Author_ID from Author where Author_ID = 1), (Select Txt_ID from Textbook where Txt_ID = 1)),
...
INSERT INTO Trans_Detail(Txt_ID, Trans_Type, Client_ID, PricePaid, Trans_Date)
Values
((Select Txt_ID from Textbook where Txt_ID = 1), 0, (Select Client_ID from Client where Client_ID = 1), 200,'2022/03/25'),
((Select Txt_ID from Textbook where Txt_ID = 1), 1, (Select Client_ID from Client where Client_ID = 2), 250,'2022/03/12'),
((Select Txt_ID from Textbook where Txt_ID = 3), 0, (Select Client_ID from Client where Client_ID = 3), 150,'2021/10/08'),
((Select Txt_ID from Textbook where Txt_ID = 4), 1, (Select Client_ID from Client where Client_ID = 5), 150,'2022/03/26'),
((Select Txt_ID from Textbook where Txt_ID = 9), 0, (Select Client_ID from Client where Client_ID = 8), 200,'2021/02/01'),
((Select Txt_ID from Textbook where Txt_ID = 6), 1, (Select Client_ID from Client where Client_ID = 7), 200,'2022/03/05');
