namespace NWU_Secondhand_Textbooks
{
    partial class MaintainClients
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ttSurname = new System.Windows.Forms.ToolTip(this.components);
            this.ttSdntNum = new System.Windows.Forms.ToolTip(this.components);
            ...
            this.ttSdntNum.SetToolTip(this.txtStudentNumber, "Enter Clients Student Number");
            // 
            // txtSurname
            // 
            ...
            this.ttSurname.SetToolTip(this.txtSurname, "Enter clients surname");
            // 
            // txtName
            // 
            ...
            this.ttName.SetToolTip(this.txtName, "Enter clients name");
            // 
            // btnAdd
            // 
            ...
            this.btnAdd.Text = "Add client to the system";
            this.ttAdd.SetToolTip(this.btnAdd, "Click to add the Client to the system");
            ...
            this.ttSdntNum.SetToolTip(this.txtDeleteStudent, "Enter Clients Student Number");
            ...
            this.ttSurname.SetToolTip(this.txtDeletSName, "Enter clients surname");
            ...
            this.ttName.SetToolTip(this.txtDeleteFName, "Enter clients name");
            ...
            this.ttRemove.SetToolTip(this.lstDelete, "Select The Client you want to delete from the system");
            // 
            // btnRemoveClient
            // 
            ...
            this.ttRemove.SetToolTip(this.btnRemoveClient, "Select to Delete Client from the system");
            ...
            this.ttUpdate.SetToolTip(this.btnUpdate, "Select to Update Client in the system");
            ...
            this.ttSdntNum.SetToolTip(this.txtChangeStudent, "Enter Clients Student Number");
            // 
            // txtChangeSurname
            // 
            ...
            this.ttSurname.SetToolTip(this.txtChangeSurname, "Enter clients surname");
            // 
            // txtChangeFName
            // 
            ...
            this.ttName.SetToolTip(this.txtChangeFName, "Enter clients name");
            this.txtChangeFName.TextChanged += new System.EventHandler(this.txtChangeFName_TextChanged);
            // 
            // label12
            // 
            ...
            this.ttSdntNum.SetToolTip(this.txtUpdateStudent, "Enter Clients Student Number");
            ...
            this.ttSurname.SetToolTip(this.txtUpdateSName, "Enter clients surname");
            ...
            this.ttName.SetToolTip(this.txtUpdateFName, "Enter clients name");
            ...
            this.ttUpdate.SetToolTip(this.lstUpdate, "Select The Client you want to Update in the system");
            // 
            // pnlTextbook
            // 
        ...
        private System.Windows.Forms.ToolTip ttSurname;
        private System.Windows.Forms.ToolTip ttSdntNum;
